...
(function () {
  ...
  function navMarkup(currentPage) {
    return ''
      ...
      + '                <div class="mega-menu__featured-divider" aria-hidden="true"></div>'
      + '                <div class="mega-menu__featured-metric">'
      + '                  <span class="mega-menu__featured-dot" aria-hidden="true"></span>'
